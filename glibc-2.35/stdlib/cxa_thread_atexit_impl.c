...
void __call_tls_dtors(void)
{
    ...
    while (tls_dtor_list)
    {
        ...
        //    0x00007ffff7e5d4c9 <+21>:    mov    rdx,QWORD PTR [rbx]
        //    0x00007ffff7e5d4cc <+24>:    mov    rax,rdx
        // >> 11
        //    0x00007ffff7e5d4cf <+27>:    ror    rax,0x11
        // xor fs:0x30
        //    0x00007ffff7e5d4d3 <+31>:    xor    rax,QWORD PTR fs:0x30
        //    0x00007ffff7e5d4dc <+40>:    mov    rcx,QWORD PTR [rbx+0x18]
        //    0x00007ffff7e5d4e0 <+44>:    mov    rdx,QWORD PTR [rip+0x169879]        # 0x7ffff7fc6d60
        //    0x00007ffff7e5d4e7 <+51>:    mov    QWORD PTR fs:[rdx],rcx
        //    0x00007ffff7e5d4eb <+55>:    mov    rdi,QWORD PTR [rbx+0x8]
        // => 0x00007ffff7e5d4ef <+59>:    call   rax
        PTR_DEMANGLE(func);
#endif
        // 遍历下一个
